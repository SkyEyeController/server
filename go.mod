...
require (
	chainmaker.org/chainmaker/common/v2 v2.3.6 // indirect
	chainmaker.org/chainmaker/pb-go/v2 v2.3.6 // indirect
	chainmaker.org/chainmaker/protocol/v2 v2.3.7 // indirect
	chainmaker.org/chainmaker/sdk-go/v2 v2.3.7 // indirect
...
require (
	...
	google.golang.org/protobuf v1.28.1 // indirect; 强制使用 v1.28.1
)
